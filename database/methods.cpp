...
MottoBikeObj::MottoBikeObj(string mark, int year, string gos_number, string last_name){
        this->mark = mark;
        this->year = year;
...
DataBase db;
QString Translator::add(string mark,int year, string gos_number, string last_name){
